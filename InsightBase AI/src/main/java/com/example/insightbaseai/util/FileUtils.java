...
public class FileUtils {
    ...
    private static final String[] SUPPORTED_EXTENSIONS = {".txt", ".pdf", ".docx", ".md", ".java", ".xml", ".json", ".yml", ".yaml", ".properties"};
    ...
    private static String extractFromPDF(File file) throws IOException {
        // For now, throw an exception with helpful message
        // TODO: Implement proper PDFBox integration
        throw new IOException("PDF processing is not yet implemented. Please convert to TXT format or use a different document type.");
    }
    ...
    private static String extractFromDOCX(File file) throws IOException {
        // For now, throw an exception with helpful message
        // TODO: Implement proper Apache POI integration
        throw new IOException("DOCX processing is not yet implemented. Please convert to TXT format or use a different document type.");
    }
    ...
    public static String getEstimatedProcessingTime(File file) {
        try {
            ...
            if (baseTime < 60) return baseTime + " seconds";
    ...
    public static void validateFile(File file) throws IOException {
        ...
        if (!isSupportedFile(file.getName())) {
            throw new IOException("Unsupported file format. Supported formats: TXT, MD, Java, XML, JSON, YAML, Properties (PDF and DOCX coming soon): " + file.getName());
        }
    }
}